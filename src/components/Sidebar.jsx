...
const Sidebar = ({ setExpand,email }) => {
                ...
                <a
                    ...
                    className={[
                        ...
                        activeName === item.name || activeName.split(".")[0] === item.name
                            ? `text-gray-300 font-semibold ${item.parent ? "bg-blue-200/20 " : "bg-transparent"
                            }`
                            : `text-white-500 ${item.parent && ""}`,
    ...
    return (
        <nav
            role="navigation"
            className={[
                "or-gradient border-r border-slate-100 shadow-sm absolute z-30 inset-y-0 left-0",
                "duration-300 ease-in-out md:fixed md:translate-x-0 z-30",
                `${isExpand
                    ? "bg-slate-50 w-72"
                    : isExpandOnHover
            ...
            >
                <SimpleBar style={{ height: "100%" }} autoHide timeout={100}>
                    <div className="text-white">
                        ...
                        <div className="my-8 flex flex-col items-center h-44 overflow--hidden">
                            ...
                            >
                                ...
                                <div
                                    className={`text-base font-semibold text-white mt-3 truncate duration-300 ${isExpand ? "" : isExpandOnHover ? "" : "w-0 h-0 opacity-0"
                                        }`}
                                >
                                    {username}
                                </div>
                                <div
                                    className={`duration-300 text-sm text-white truncate ${isExpand ? "" : isExpandOnHover ? "" : "w-0 h-0 opacity-0"
                                        }`}
                                >
                                    {company}
                                </div>
